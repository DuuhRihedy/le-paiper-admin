...
export const MOCK_PRODUCTS = [
    { id: pid(1), name: "Caderno Espiral 200fls", category: "Cadernos", price: 32.9, cost: 18.5, stock: 45, minStock: 10, color: "#8B5CF6", sku: null, createdAt: daysAgo(60) },
    { id: pid(2), name: "Caneta Gel Azul 0.7", category: "Canetas", price: 4.5, cost: 1.8, stock: 120, minStock: 30, color: "#3B82F6", sku: null, createdAt: daysAgo(55) },
    { id: pid(3), name: "Lápis Grafite HB (cx 12)", category: "Lápis", price: 15.9, cost: 7.2, stock: 38, minStock: 15, color: "#F59E0B", sku: null, createdAt: daysAgo(50) },
    { id: pid(4), name: "Borracha Branca Macia", category: "Borrachas", price: 2.5, cost: 0.9, stock: 200, minStock: 50, color: "#EC4899", sku: null, createdAt: daysAgo(45) },
    { id: pid(5), name: "Papel Sulfite A4 (500fls)", category: "Papéis", price: 28.9, cost: 19.0, stock: 60, minStock: 20, color: "#10B981", sku: null, createdAt: daysAgo(40) },
    { id: pid(6), name: "Régua 30cm Transparente", category: "Acessórios", price: 3.9, cost: 1.2, stock: 85, minStock: 20, color: "#6366F1", sku: null, createdAt: daysAgo(38) },
    { id: pid(7), name: "Marca-texto Amarelo", category: "Canetas", price: 5.9, cost: 2.1, stock: 70, minStock: 25, color: "#FBBF24", sku: null, createdAt: daysAgo(35) },
    { id: pid(8), name: "Tesoura Escolar 13cm", category: "Acessórios", price: 8.9, cost: 3.5, stock: 4, minStock: 10, color: "#EF4444", sku: null, createdAt: daysAgo(30) },
    { id: pid(9), name: "Cola Bastão 21g", category: "Colas", price: 4.2, cost: 1.5, stock: 3, minStock: 15, color: "#14B8A6", sku: null, createdAt: daysAgo(25) },
    { id: pid(10), name: "Estojo Escolar Básico", category: "Acessórios", price: 19.9, cost: 8.0, stock: 25, minStock: 8, color: "#A855F7", sku: null, createdAt: daysAgo(20) },
    { id: pid(11), name: "Fita Adesiva Transparente", category: "Acessórios", price: 6.5, cost: 2.8, stock: 55, minStock: 15, color: "#64748B", sku: null, createdAt: daysAgo(15) },
    { id: pid(12), name: "Agenda 2026", category: "Cadernos", price: 45.0, cost: 22.0, stock: 18, minStock: 5, color: "#D946EF", sku: null, createdAt: daysAgo(10) },
];
